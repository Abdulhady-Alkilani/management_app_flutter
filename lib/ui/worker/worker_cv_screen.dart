...
class WorkerCvScreen extends StatefulWidget {
  const WorkerCvScreen({super.key});
...
class _WorkerCvScreenState extends State<WorkerCvScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<WorkerProvider>().fetchCv();
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('السيرة الذاتية - العامل')),
  ...
  void _showEditCvDialog(BuildContext context, WorkerProvider provider) {
    final cv = provider.cv;
  ...
  void _showAddSkillsDialog(BuildContext context, WorkerProvider provider) {
